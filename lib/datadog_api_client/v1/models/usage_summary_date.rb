...
module DatadogAPIClient::V1
  ...
  class UsageSummaryDate
    ...
    # Shows the high-water mark of all APM ECS Fargate tasks over all hours in the current date for all organizations.
    attr_accessor :apm_fargate_count_hwm
    ...
    def self.attribute_map
      {
        ...
        :'apm_fargate_count_hwm' => :'apm_fargate_count_hwm',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'apm_fargate_count_hwm')
        self.apm_fargate_count_hwm = attributes[:'apm_fargate_count_hwm']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          apm_fargate_count_hwm == o.apm_fargate_count_hwm &&
